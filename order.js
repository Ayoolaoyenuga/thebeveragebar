var typed = new Typed("#text", {
  strings: [
    ...
    " creativity is cooked, crafted, seasoned, and served.",
    " chilled meets cozy and deliciousness knows no limits",
  ],
  typeSpeed: 50,
  backSpeed: 60,
  backDelay: 1000,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  products.forEach((product) => {
    product.addEventListener("click", () => {
      ...
      updateCartUI();
      showPopupMessage(`${name} added to order ✅`);
    });
  });
...
`;
  ...
  checkoutForm.addEventListener("submit", function (e) {
    ...
    // Dummy checkout - always succeeds
